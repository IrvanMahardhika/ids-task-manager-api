...
class TaskRepository {
    ...
    findOne(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const onlineCourse = yield TaskModel.findOne(Object.assign(Object.assign({}, sequelizeOptions), { transaction: this.transaction }));
    ...
    findAll(options) {
        return __awaiter(this, void 0, void 0, function* () {
            const sequelizeOptions = helpers_1.repositoryOptionConverter(options);
            const onlineCourses = yield TaskModel.findAll(Object.assign(Object.assign({}, sequelizeOptions), { transaction: this.transaction }));
